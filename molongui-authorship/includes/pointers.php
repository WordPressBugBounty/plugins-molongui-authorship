...
class Pointers
{
    ...
    public function add_pointers( $pointers, $prefix )
    {
        if ( apply_filters( 'molongui_authorship/show_pointers', true ) )
        {
            ...
            $box     = ( !empty( $options['author_box_enabled'] ) and !empty( $options['appearance_submenu'] ) );
            ...
            if ( apply_filters( 'molongui_authorship/show_options_pointers', true ) )
            {
                $pointers = array_merge( $pointers, array
                (
            ...
            if ( apply_filters( 'molongui_authorship/show_edit_post_pointers', false ) )
            {
                ...
                (
                    ...
                    (
                        ...
                        'post_type'  => explode( ",", Settings::get( 'post_types', array( 'post' ) ) ),
