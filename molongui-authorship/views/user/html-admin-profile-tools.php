...
<div id="molongui-author-tools">
    ...
    <table class="form-table" role="presentation">
        ...
        <tr class="user-m-archive-author-wrap">
            ...
            <td>
                <label for="molongui_author_archived">
                    <input type="checkbox" name="molongui_author_archived" id="molongui_author_archived" value="1" <?php checked( get_the_author_meta( 'molongui_author_archived', $user->ID ) ); ?>>
                    <?php _e( "Check to archive this author and prevent them from being eligible as an author for your posts.", 'molongui-authorship' ); ?>
                </label>
            </td>
        </tr>
