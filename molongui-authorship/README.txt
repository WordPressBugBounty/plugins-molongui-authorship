...
* **Fixed**: PHP warning for undefined variable `$post_types`.
* **Fixed**: Minor admin styling issues.
* **Changed**: Updated framework files to v3.4.3.
* **Changed**: Added compatibility with WordPress 7.1.
* **Removed**: Peepeth social profile following the network's discontinuation.
...
* Added: Bluesky as author social profile option.
* Added: Strava as author social profile option.
* Added: Facebook Messenger as author social profile option.
* Added: Flipboard Messenger as author social profile option.
* Added: QQ as author social profile option.
* Added: IMDb as author social profile option.
* Fixed: Post byline now omits the co-authors count when configured not to display co-authors.
* Fixed: Required Block Editor scripts are now loaded exclusively on the edit post screen.
...
* Fixed: Co-authored posts are now listed on the author page when using Elementor's Loop Grid widget.
...
* Fixed: Incorrect post count computed for authors.
